...
Recorded in:
- `TASK_PACKET_SUMMARY.md` â†’ **LIFECYCLE STATE**
...
- Execution progress does NOT imply lifecycle changes
  NOTE:
- "Blocked" and "Completed" are NOT lifecycle states in this system.
- Blocking is represented via Execution State = Blocked.
- Completion is represented via Execution State = Completed.
- Lifecycle remains Active unless a human explicitly sets Paused or Abandoned.
...
Recorded in:
- `TASK_PACKET_SUMMARY.md` â†’ **EXECUTION STATE**

Authority:
- **Gemini** â€” while no production source file has been modified
- **Codex** â€” once any production source file has been modified
...
|-----------|-----------|----------|
| Lifecycle | Human only | TASK_PACKET_SUMMARY.md |
| Execution | Gemini â†’ Codex | TASK_PACKET_SUMMARY.md |
...
- `AI_SESSION/INSTRUCTIONS/CHILD_WORK_RULES.md`
- `AI_SESSION/INSTRUCTIONS/SUBTASKS.md`
- `AI_SESSION/INSTRUCTIONS/BUGTASKS.md`
